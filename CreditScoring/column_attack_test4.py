...
value_ranges = {
    'NumberOfTime30-59DaysPastDueNotWorse': list(range(21)),  # Will no longer be evaluated
    'NumberOfTime60-89DaysPastDueNotWorse': list(range(21)),  # Will no longer be evaluated
    'NumberOfTimes90DaysLate': list(range(21)),               # Will no longer be evaluated
...
if os.path.exists(results_file):
    ...
    for i, row in df.iterrows():
        ...
        for column, _ in value_ranges.items():
            ...
            #skip DaysLate as these dont affect anomalyScore
